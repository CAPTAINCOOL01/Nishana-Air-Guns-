...
create table if not exists public.products (
  ...
  pdp_url           text,                       -- dedicated 'product-<slug>.html' route for the storefront card
  hero_photo_url    text,                       -- convenience cache of the primary photo's public URL
  buy_enabled       boolean default true,       -- retained for admin compatibility; current storefront always shows both actions
...
insert into public.products (
  ...
  ('star-rx-gen3', 'Star RX Gen 3', 'Camstar', 'air-pistols', 25000, 29000, 'Semi-auto CO₂',
   '[".177 CAL","UP TO 3 J","CO₂ SEMI-AUTO","4 × 8 RND"]'::jsonb,
   'Made-in-India .177 CO₂ semi-automatic air pistol supplied with four 8-round rotary magazines and a complete carry kit.',
  ...
  ('co2-cylinders-5', 'CO₂ Cylinders — Pack of 5', 'Camstar', 'accessories', 550, null, null,
   '["12 G","PACK OF 5","SINGLE-USE"]'::jsonb,
   'Five single-use 12 g CO₂ capsules for compatible airguns. Check the product manual before use.',
   'product-co2-cylinders-5.html', 'https://camstarsports.com/products/co2-cylinders.jpg', true, true, 10,
   null, null, null, null,
  ...
  ('star-match-pellets', 'Star Match Diabolo Pellets', 'Camstar', 'accessories', 450, null, null,
   ...
   'Flat-head .177 (4.5 mm) diabolo pellets for paper-target practice, manufacturer-labelled 0.524 g and supplied in a 300-count tin.',
   'product-star-match-pellets.html', 'https://camstarsports.com/products/star-match-diabolo.png', true, true, 11,
  ...
  ('rx-gen3-magazine', 'Star RX Gen 3 CO₂ Magazine Assembly', 'Camstar', 'spare-parts', 6499, null, 'Genuine replacement',
   '["GENUINE","CO₂ ASSEMBLY","RX GEN 3 ONLY"]'::jsonb,
   'Genuine replacement CO₂ magazine assembly made specifically for the Camstar Star RX Gen 3 air pistol.',
   'product-rx-gen3-magazine.html', 'https://camstarsports.com/rx-gen3-co2-magazine.jpeg', true, true, 20,
   null, null, null, null,
   'Existing SKU migrated from products.js; spare part (not an airgun).', 'ramayanaprav@gmail.com', now()),
  ('aerosoft-x1', 'Aerosoft X1 CO₂ Air Pistol', 'Aerosoft', 'air-pistols', 36000, 45000, 'Compact CO₂',
   '[".177 BB","12 G CO₂","SEMI-AUTO","350 FPS LABEL"]'::jsonb,
   'Compact .177 CO₂ BB pistol with a semi-automatic action. The supplied manual is labelled 350 FPS; exact performance varies.',
   'product-aerosoft-x1.html', '/img/products/aerosoft-x1/1.webp', true, true, 2,
   null, null, null, null,
  ...
  ('asg-x9-classic', 'ASG X9 Classic CO₂ Air Pistol', 'ASG', 'air-pistols', 57000, 65000, 'Full-metal blowback',
   '["4.5 MM BB","12 G CO₂","16 RND","1.6 J"]'::jsonb,
   'Full-metal semi-automatic CO₂ pistol with hard blowback, a 16-round steel-BB magazine and last-shot slide hold-open.',
   'product-asg-x9-classic.html', '/img/products/asg-x9-classic/1.webp', true, true, 3,
   '4.5', 'steel-bb', 'co2', null,
   'Owner-attested photo and dealer availability recorded on 2026-07-20; enquiry-only catalogue listing.', 'ramayanaprav@gmail.com', now()),
  ('beretta-84fs', 'Beretta Mod. 84 FS CO₂ Air Pistol', 'Umarex · Beretta', 'air-pistols', 72000, 85000, 'Licensed replica',
   '["4.5 MM BB","12 G CO₂","17 RND","BLOWBACK"]'::jsonb,
   'Compact licensed Beretta replica by Umarex with all-metal construction, realistic blowback and a 17-round steel-BB magazine.',
   'product-beretta-84fs.html', '/img/products/beretta-84fs/1.webp', true, true, 4,
   '4.5', 'steel-bb', 'co2', null,
   'Owner-attested photo and dealer availability recorded on 2026-07-20; enquiry-only catalogue listing.', 'ramayanaprav@gmail.com', now()),
  ('beretta-m92-a1', 'Beretta M92 A1 CO₂ Air Pistol', 'Umarex · Beretta', 'air-pistols', 73000, 85000, 'Full-metal blowback',
   '["4.5 MM BB","12 G CO₂","18 RND","SEMI-AUTO"]'::jsonb,
   'Standard Umarex 5.8144 configuration with full-metal construction, semi-automatic blowback and an 18-round steel-BB magazine.',
   'product-beretta-m92-a1.html', '/img/products/beretta-m92-a1/1.webp', true, true, 5,
   '4.5', 'steel-bb', 'co2', null,
   'Owner-attested photo and dealer availability recorded on 2026-07-20; enquiry-only catalogue listing.', 'ramayanaprav@gmail.com', now()),
  ('kwc-k18', 'KWC K18 CO₂ Blowback BB Pistol', 'KWC', 'air-pistols', 58000, 64000, 'Select-fire blowback',
   '["4.5 MM BB","18 RND","SEMI + FULL","1.6 J"]'::jsonb,
   'KWC Model 20-series CO₂ pistol with a metal slide, full blowback, fixed hop-up and selectable semi/full-auto fire.',
   'product-kwc-k18.html', '/img/products/kwc-k18/FullSizeRender_5f838eab-803d-45e7-bfcf-87367fd94b79.webp', true, true, 6,
   '4.5', 'steel-bb', 'co2', null,
   'Dealer availability recorded on 2026-07-20; enquiry-only listing with no in-stock claim.', 'ramayanaprav@gmail.com', now()),
  ('kwc-m92', 'KWC M92 CO₂ Blowback BB Pistol', 'KWC', 'air-pistols', 62000, 65000, 'Full-metal select-fire',
   '["4.5 MM BB","18 RND","SEMI + FULL","1.5 J"]'::jsonb,
   'Full-metal KWC Model 23-series CO₂ pistol with blowback, an 18-round steel-BB magazine and selectable semi/full-auto fire.',
   'product-kwc-m92.html', '/img/products/kwc-m92/FullSizeRender_b28aaf22-b99f-4a33-8ccb-8990e03e7c92.webp', true, true, 7,
   '4.5', 'steel-bb', 'co2', null,
   'Dealer availability recorded on 2026-07-20; enquiry-only listing with no in-stock claim.', 'ramayanaprav@gmail.com', now()),
  ('hn-hornet-pellets', 'H&N Hornet Pellets', 'H&N', 'accessories', 1750, 1850, 'Brass-tip pellet',
   '[".177 CAL","9.57 GR","225 CT","POINTED"]'::jsonb,
   'Medium-weight .177 pointed pellets with an embedded brass tip, 0.620 g / 9.57 gr, 225 per tin. H&N specifies a minimum 7.5 J.',
   'product-hn-hornet-pellets.html', '/img/products/hn-hornet-pellets/FullSizeRender_301a35f3-1d50-4557-97be-1cbd2492cab8.webp', true, true, 12,
   '4.5', null, null, null,
   'Dealer availability recorded on 2026-07-20; enquiry-only listing with no in-stock claim.', 'ramayanaprav@gmail.com', now())
